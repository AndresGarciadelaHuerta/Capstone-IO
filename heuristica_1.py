...
def heuristica_1(lista_aux, demanda_ordenada):
    con = -1
...
if __name__ == '__main__':
    ...
    #lista_2 = [0, 11, 0, 1, 24, 22, 0, 5, 10, 0, 0, 0, 10, 0, 0, 24, 0, 0,
    # 16, 11, 20, 0, 21, 0, 30, 0, 0, 16, 2, 7, 0,
    #            27, 0, 0, 0, 0, 26, 11, 0, 18, 25, 7, 0, 0, 0, 0, 0, 0, 0,
    # 9, 4, 0, 0, 9, 27, 7, 12, 0, 43, 1, 0, 27, 11,
    #            26, 8, 0, 0, 0, 0, 0, 10, 6, 0, 38, 0, 0, 18, 48, 0, 6, 0,
    #           0, 0, 0, 12, 1, 23, 12, 0, 15, 25, 58]
    ...
    # 8, 3, 30, 20, 29, 2, 31, 2, 49, 3, 4, 25, 18, 14, 4, 42, 8, 4, 8, 7,
    # 41, 17, 5, 28, 40, 25, 3, 2, 13, 3, 6, 14, 12, 17, 12, 4, 2, 25, 45,
    # 24, 21, 13, 59, 18, 12, 39, 21, 41, 15, 3, 10, 12, 7, 13, 18, 15, 16, 52, 12, 7, 34, 60, 10, 16, 3, 4, 5, 14, 21, 10, 31, 23, 2, 24, 32, 33]

    #final
    with open('dist_inicial_heur1.csv', 'r') as file:
        lista_2 = []
        for li in file:
            lista_2.append(int(li.strip()))

    # 85.8
    #lista_2 = [1, 29, 4, 17, 36, 37, 14, 22, 17, 14, 2, 13, 28, 3, 2, 39,
    # 8, 3, 30, 20, 29, 2, 31, 3, 49, 3, 4, 25, 18, 14, 4, 42, 9, 4, 8, 7, 41, 17, 5, 28, 40, 25, 3, 2, 13, 3, 6, 14, 12, 17, 12, 4, 2, 25, 45, 24, 21, 13, 59, 18, 12, 39, 21, 41, 15, 3, 10, 12, 7, 13, 18, 15, 16, 52, 12, 7, 31, 60, 10, 16, 4, 4, 5, 14, 21, 10, 31, 23, 3, 24, 32, 32]
    ...
    for repe in range(5):
        ...
        while (intervalo_alto - intervalo_bajo) > 2 or numero_simulaciones <\
                50:
